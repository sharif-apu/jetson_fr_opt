...
configurations = {
    1: dict(
        ...
        MODEL_ROOT = 'D:\\faceRecon\\train_face_recog\\fadata_model_retrain', # the root to buffer your checkpoints
        LOG_ROOT = 'D:\\faceRecon\\train_face_recog\\log', # the root to log your train/val status
        BACKBONE_RESUME_ROOT = 'D:\\faceRecon\\train_face_recog\\resume\\', # the root to resume training from a saved checkpoint
        HEAD_RESUME_ROOT = 'D:\\faceRecon\\train_face_recog\\resume\\', # the root to resume training from a saved checkpoint
